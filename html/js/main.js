function generateSprinker(id, name)
{
  html  = '<div style="display: none" id="sprinkler' + id + '">';
  html += '<button id="override' + id + '">Manual</button>';
  html += '<button id="toggle' + id + '">Enable</button>';
  html += '<span class="name">' + name + '</span>';
  html += 'Runtime';
  html += '<select id="runtime' + id + '">';
